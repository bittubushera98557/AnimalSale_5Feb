...
public class MainCatAdapter extends RecyclerView.Adapter<MainCatAdapter.MyViewHolder> {
    ...
    @Override
    public MainCatAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_top_cate, parent, false);
        Log.e(TAG, "onCreateViewHolder"  );

        return new MainCatAdapter.MyViewHolder(itemView);
    }

    String outputText = "";

    @Override
    public void onBindViewHolder(MainCatAdapter.MyViewHolder holder, final int position) {
